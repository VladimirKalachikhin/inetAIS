...
*/
global $netAISgpsdHost,$netAISgpsdPort;
if(!$host) $host = $netAISgpsdHost;
if(!$port) $port = $netAISgpsdPort;
if(is_array($host)) { 	// спрашивать у SignalK
	//error_log("fGPSD.php getPosAndInfo: will ask spatial info from SignalK");
	echo "fGPSD.php getPosAndInfo: will ask spatial info from SignalK\n";
...
elseif($host and $port) { 	// спрашивать у gpsd
	...
	echo "fGPSD.php getPosAndInfo: will ask spatial info from gpsd\n";
